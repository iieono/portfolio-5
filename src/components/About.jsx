...
function About() {
  return (
    <div className="lg:w-10/12 h-full jetbrains font-extralight  lg:text-base about overflow-auto">
      {/* <InteractiveBackground /> */}
      <div className="flex flex-col lg:flex-row w-full h-full p-5 lg:p-20 overflow-auto">
        {/* first side */}
        <div className="h-full w-full p-2 flex flex-col gap-10 overflow-visible">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-8 links-container ">
              <div className="flex flex-col gap-3 links-name-container">
