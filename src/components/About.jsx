  ...
  return (
    <div className="lg:w-10/12 h-full jetbrains font-extralight text-sm lg:text-base about overflow-auto">
      ...
      <div className="flex flex-col lg:flex-row w-full gap-10 h-full p-5 lg:p-20 overflow-scroll">
        ...
        {/* second side */}
        <div className="h-4/5 w-full lg:w-2/3 p-2 flex flex-col items-end justify-end gap-10 overflow-visible">
          <div className="flex h-full flex-wrap gap-x-10 pr-2">
          ...
          <div className="flex h-full flex-wrap pr-2 gap-x-10">
